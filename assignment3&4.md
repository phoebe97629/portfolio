...
<font color="red"> Insight: </font> It is really important to identify the target audience when designing the graph. Becuase designer should concider what kind of information the audiance want to know and what information they already know and unnecessary to them.  

### Step three: wireframe a solution
Here is my wireframe. The most simple way to reduce confusion is reducing the information each graoup includes, and add more graphs. So I seperated the grpah into two comparable bar chart with salary and total compensation as y-axis and clubs name as x-axis. I used dark green for the graph to represent money. 
...
<font color="red"> Insight: </font> According the user feedbacks, the new design meet the usefulness, perceptibility, and intuitiveness requirements. However, by eliminating the position cause a little bit confuse. The audiance didn't mention the aesthetics and engagement parts, but I believe I should do better on that. I also found that for the person who are not interested in the MLS games, they didn't take the interview seriously. The suggestiong they provided are very general or limited. But for the people love wathing games, they are keep inquiring different questions.
...
1. Tableau sometimes is difficult to use. As a designer, its lack of flexibility. 
2. I tried to move the x-axis title to the bottom. But don't know how. I google the solution, and many people have such issues but have no solution. 
3. The color themes are very limited. 
4. The label position. Since each bar divided by the position, the label cannot be seted at the top of each bar. 
